...
def assert_eq(actual_value: Any, expected_value: Any, error_msg: str = None) -> None:
    try:
        ...
        attach_error_details("AssertionError", error_msg or "Сравниваемые значения не равны", "assert_eq", **error_details)
        raise
...
def validate_json_structure(
    ...
    if missing_fields:
        ...
        attach_error_details("ValidationError", f"Отсутствуют обязательные поля: {missing_fields}", "validate_json_structure", **error_details)
