...
from src.backend.services.shop.models.request_models import RegisterRequest, LoginRequest, AddItemToCartRequest
from src.backend.services.shop.models.response_models import RegistrationResponse, LoginResponse, CartResponse, CatalogResponse
